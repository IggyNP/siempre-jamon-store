      ...
      <div className="group relative z-30 mt-3 flex cursor-pointer rounded-lg bg-white shadow">
        ...
        <div className="w-full p-8">
          ...
          <p className="mt-4 text-gray-600 md:w-80">
            1 paquete de 150g. de jamón ibérico todos los meses.
          </p>
        </div>
      </div>
      <div className="group relative z-30 mt-3 flex cursor-pointer rounded-lg bg-white shadow">
        ...
        <div className="w-full p-8">
          ...
          <p className="mt-4 text-gray-600 md:w-80">
            2 paquetes de 150g. de jamón ibérico todos los meses.
          </p>
        </div>
      </div>
      <div className="group relative z-30 mt-3 flex cursor-pointer rounded-lg bg-white shadow">
        ...
        <div className="w-full p-8">
          ...
          <p className="mt-4 text-gray-600 md:w-80">
            4 paquetes de 150g. de jamón ibérico todos los meses.
          </p>
        </div>
      </div>
    </div>
